...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_claim_cards_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::claim_cards(_rt::string_lift(bytes0));
    let ptr2 = (&raw mut _RET_AREA.0).cast::<u8>();
    let vec3 = (result1.into_bytes()).into_boxed_slice();
    let ptr3 = vec3.as_ptr().cast::<u8>();
    let len3 = vec3.len();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_claim_cards<T: Guest>(arg0: *mut u8) {
    let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
    _rt::cabi_dealloc(l0, l1, 1);
}
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn _export_verify_claim_cabi<T: Guest>(
    arg0: *mut u8,
    arg1: usize,
) -> *mut u8 {
    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
    let len0 = arg1;
    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
    let result1 = T::verify_claim(_rt::string_lift(bytes0));
    let ptr2 = (&raw mut _RET_AREA.0).cast::<u8>();
    let vec3 = (result1.into_bytes()).into_boxed_slice();
    let ptr3 = vec3.as_ptr().cast::<u8>();
    let len3 = vec3.len();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_verify_claim<T: Guest>(arg0: *mut u8) {
    let l0 = *arg0.add(0).cast::<*mut u8>();
    let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
    _rt::cabi_dealloc(l0, l1, 1);
}
...
pub trait Guest {
    ...
    fn claim_cards(payload: _rt::String) -> _rt::String;
    fn verify_claim(payload: _rt::String) -> _rt::String;
    /// Event export
...
macro_rules! __export_world_giftcards_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        * mut u8,) { unsafe { $($path_to_types)*:: __post_return_lnurl_params::<$ty >
        ...
        "claim-cards")] unsafe extern "C" fn export_claim_cards(arg0 : * mut u8, arg1 :
        usize,) -> * mut u8 { unsafe { $($path_to_types)*::
        _export_claim_cards_cabi::<$ty > (arg0, arg1) } } #[unsafe (export_name =
        "cabi_post_claim-cards")] unsafe extern "C" fn _post_return_claim_cards(arg0 : *
        mut u8,) { unsafe { $($path_to_types)*:: __post_return_claim_cards::<$ty > (arg0)
        } } #[unsafe (export_name = "verify-claim")] unsafe extern "C" fn
        export_verify_claim(arg0 : * mut u8, arg1 : usize,) -> * mut u8 { unsafe {
        $($path_to_types)*:: _export_verify_claim_cabi::<$ty > (arg0, arg1) } } #[unsafe
        (export_name = "cabi_post_verify-claim")] unsafe extern "C" fn
        _post_return_verify_claim(arg0 : * mut u8,) { unsafe { $($path_to_types)*::
        __post_return_verify_claim::<$ty > (arg0) } } #[unsafe (export_name =
...
A\x0f\x01BS\x01r\x02\x05tables\x02ids\x04\0\x13storage-get-request\x03\0\0\x01ks\
...
\x04\0\x0clnurl-params\x01\x01\x04\0\x0elnurl-callback\x01\x01\x04\0\x0bclaim-ca\
rds\x01\x01\x04\0\x0cverify-claim\x01\x01\x04\0\x0fon-invoice-paid\x01\x01\x04\0\
\x1alnbits:extension/giftcards\x04\0\x0b\x0f\x01\0\x09giftcards\x03\0\0\0G\x09pr\
